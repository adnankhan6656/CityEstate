...
export default function CreateListing() {
  ...
  return (
    <main className='p-3 max-w-5xl mx-auto shadow-md my-4 mt-7'>
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-4 sm:flex-row">
        ...
        <input type="text" maxLength='62'
          minLength='10'
          required placeholder='Name'      id='name' className="border rounded-lg p-3 bg-[#f1f1f1] outline-[#0073E1]" onChange={handleChange}
          value={formData.name}  />
        <textarea
          type='text'
